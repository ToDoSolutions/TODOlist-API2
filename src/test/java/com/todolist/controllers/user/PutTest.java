...
class PutTest {
    ...
    void setUp() {
        ...
        showUser = restTemplate.postForObject(uri + "/user", user, ShowUser.class);
    ...
    void testPutFine() {
        ...
        user.setIdUser(showUser.getIdUser());
        ShowUser response = restTemplate.exchange(uri + "/user", HttpMethod.PUT, new HttpEntity<>(user), ShowUser.class).getBody();
    ...
    void testPutNotExist() {
        user.setIdUser(99L);
        ManagerException.of(assertThrows(HttpClientErrorException.class, () -> restTemplate.exchange(uri + "/user", HttpMethod.PUT, new HttpEntity<>(user), ShowUser.class)))
    ...
    void testPutWithNullOrEmptyName() {
        ...
        user.setName("");
        response = restTemplate.exchange(uri + "/user", HttpMethod.PUT, new HttpEntity<>(user), ShowUser.class).getBody();
