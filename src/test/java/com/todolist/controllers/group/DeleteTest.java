...
class DeleteTest {
    ...
    void testDeleteGroupFine() {
        ShowGroup response = restTemplate.exchange(uri + "/group/1", HttpMethod.DELETE, null, ShowGroup.class).getBody();
        assertEquals(1, response.getIdGroup(), "IdGroup is not correct");
        ManagerException.of(assertThrows(HttpClientErrorException.class, () -> restTemplate.getForObject(uri + "/group/1", ShowGroup.class)))
    ...
    void testDeleteGroupWithWrongId() {
        ManagerException.of(assertThrows(HttpClientErrorException.class, () -> restTemplate.exchange(uri + "/group/0", HttpMethod.DELETE, null, ShowGroup.class)))
                .assertMsg("The group with idGroup 0 does not exist.")
                .assertStatus("Not Found")
                .assertPath("/api/v1/group/0");
    }
    ...
    void testDeleteUserFine() {
        ...
        response = restTemplate.exchange(uri + "/group/1/user/1", HttpMethod.DELETE, null, ShowGroup.class).getBody();
        assertEquals(1, response.getIdGroup(), "IdGroup is not correct");
        assertTrue(response.getUsers().stream().allMatch(user -> user.getIdUser() != 1), "User with idUser 1 exist.");
        ShowUser response2 = restTemplate.getForObject(uri + "/user/1", ShowUser.class);
        assertEquals(1, response2.getIdUser(), "IdUser is not correct");
    }

    @Test
    void testDeleteUserWithWrongId() {
        ManagerException.of(assertThrows(HttpClientErrorException.class, () -> restTemplate.exchange(uri + "/group/1/user/0", HttpMethod.DELETE, null, ShowGroup.class)))
                .assertMsg("The user with idUser 0 does not exist.")
                .assertStatus("Not Found")
                .assertPath("/api/v1/group/1/user/0");
    }

    @Test
    void testDeleteUserWithWrongIdGroup() {
        ManagerException.of(assertThrows(HttpClientErrorException.class, () -> restTemplate.exchange(uri + "/group/0/user/1", HttpMethod.DELETE, null, ShowGroup.class)))
                .assertMsg("The group with idGroup 0 does not exist.")
                .assertStatus("Not Found")
                .assertPath("/api/v1/group/0/user/1");
    }

    @Test
    void testDeleteAllUsersFine() {
        ShowGroup response = restTemplate.exchange(uri + "/group/1/users", HttpMethod.DELETE, null, ShowGroup.class).getBody();
        assertEquals(1, response.getIdGroup(), "IdGroup is not correct");
    ...
    void testDeleteAllUsersWithWrongIdGroup() {
        ManagerException.of(assertThrows(HttpClientErrorException.class, () -> restTemplate.exchange(uri + "/group/0/users", HttpMethod.DELETE, null, ShowGroup.class)))
                .assertMsg("The group with idGroup 0 does not exist.")
                .assertStatus("Not Found")
                .assertPath("/api/v1/group/0/users");
    }
    /* --- TASK --- */
    @Test
    void testDeleteTaskFine() {
        ...
        response = restTemplate.exchange(uri + "/group/1/task/1", HttpMethod.DELETE, null, ShowGroup.class).getBody();
        assertEquals(1, response.getIdGroup(), "IdGroup is not correct");
        ...
        ShowTask response2 = restTemplate.getForObject(uri + "/task/1", ShowTask.class);
        assertEquals(1, response2.getIdTask(), "IdTask is not correct");
    }

    @Test
    void testDeleteTaskWithWrongId() {
        ManagerException.of(assertThrows(HttpClientErrorException.class, () -> restTemplate.exchange(uri + "/group/1/task/0", HttpMethod.DELETE, null, ShowGroup.class)))
                .assertMsg("The task with idTask 0 does not exist.")
                .assertStatus("Not Found")
                .assertPath("/api/v1/group/1/task/0");
    }

    @Test
    void testDeleteTaskWithWrongIdGroup() {
        ManagerException.of(assertThrows(HttpClientErrorException.class, () -> restTemplate.exchange(uri + "/group/0/task/1", HttpMethod.DELETE, null, ShowGroup.class)))
                .assertMsg("The group with idGroup 0 does not exist.")
                .assertStatus("Not Found")
                .assertPath("/api/v1/group/0/task/1");
    }
}
