    ...
    public static FilterNumber parse(String filterWithNumber) {
        ...
        if (Pattern.compile("[<>=]\\d+").matcher(filterWithNumber).matches()) {
            ...
            return switch(filter) {
                ...
                default -> throw new IllegalArgumentException("The filter is not valid and it should have a parameter filter (<,>,=,<=,=<,>=,=>,==,!=,<>,><) and a number without decimals.");
            };
            ...
            return switch(filter) {
                ...
                default -> throw new IllegalArgumentException("The filter is not valid and it should have a parameter filter (<,>,=,<=,=<,>=,=>,==,!=,<>,><) and a number.");
            };
        } else {
