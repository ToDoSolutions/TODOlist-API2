...
public class ExceptionToJson {
    ...
    private ExceptionToJson(HttpStatusCodeException exception) {
    ...
    public static ExceptionToJson of(HttpStatusCodeException exception) {
        return new ExceptionToJson(exception);
    }

    public ExceptionToJson assertStatus(String expected) {
        if (!Objects.equals(status, expected.trim()))
            throw new AssertionError("Error Status: " + status + " != " + expected);
        return this;
    }

    public ExceptionToJson assertPath(String expected) {
        if (!Objects.equals(path, expected.trim()))
            throw new AssertionError("Error Path: " + path + " != " + expected);
        return this;
    }

    public ExceptionToJson assertMsg(String expected) {
