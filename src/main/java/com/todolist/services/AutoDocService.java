...
public class AutoDocService {
    ...
    public String[] getPlanning(String repoName, String username, String individual) {
        ...
        for (TimeTask timeTask : timeTasks) {
            taskTable.addRow(timeTask.getTitle().trim(), timeTask.getDescription() != null ? timeTask.getDescription().trim(): null, timeTask.getEmployees().stream().map(Employee::getName).reduce((s, s2) -> s + ", " + s2).orElse("")
