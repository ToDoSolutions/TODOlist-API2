...
INSERT INTO `user` (`avatar`, `bio`, `email`, `location`, `name`, `surname`, `password`, `username`, `token`)
VALUES ('https://es.web.img3.acsta.net/pictures/17/05/19/13/05/463219.jpg', '...',
        '...', 'mi casa', '...', '...', '123456', 'alesanfe' , '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'),
        ('https://es.web.img3.acsta.net/pictures/17/05/19/13/05/463219.jpg', 'Ser celestial, nacido para ayudar',
        'miscosama@gmail.com', 'mi casa', 'Misco', 'Jones', '123456', 'miscosama', 'null'),
       ('http://pm1.narvii.com/6120/9cd70762280f430ded8158c06c287e82b84d0101_00.jpg',
        ...
        'niunpelotonto@tortilla.ong', '3000 viviendas', 'El Pelón', 'Calvo', '123456', 'niunpelotonto', 'null'),
       ...
       ('https://img-17.ccm2.net/M5IDYIxs4R9RmHBLCt9l-PWqYLc=/500x/eff2597a02394167920c9d1cf7945a3c/ccm-faq/C3.JPG',
        ...
        'tucopito@hotmal.com', 'Khaenri\'ah', 'Kaeya', 'Alberich', '123456', 'tucopito', 'null'),
